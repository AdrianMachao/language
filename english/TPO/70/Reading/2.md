...
wink
wrinkle:（年老时皮肤上的）皱纹|（使）起皱纹；（使）起褶皱
wrinkled: 长满皱纹的
accommodate:适应，迁就,“容纳、迁就”（使外部适应内部）
accommodate someone‘s needs/requests
diminish:减少，减小，降低
shrank(shrink):（使）缩小，（使）变小
broke apart:破碎；分裂；解体
portions:一部分;一份
landmasses:整块陆地，大陆，陆地板块
continual:（通常指令人讨厌或引起不便地）频频的，频繁的，再三的
...
stratigraphic:地层学的
extensive:广阔的，大面积的；覆盖范围广的
problematic:成问题的；疑难的
conundrum:难题；复杂的问题
interleaving:交织，交错，插叙
contiguous:相近的，相邻的;毗邻的;互相连接的
...
build up of: 累积的结果或过程本身
subside（状况）趋于平缓，平息
subsidiary:辅助的；次要的|子公司;附属公司
subsidy:补助金;津贴，补贴
