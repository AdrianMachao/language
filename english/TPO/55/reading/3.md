...
solitary: 独自的，唯一的，单个的
scattered: （随意地）撒，使散落, 从一点向四周随意、杂乱地抛洒。
disperse: （有组织地）驱散，使扩散,从聚集到广泛、均匀地疏散或扩散。
sprinkle: （少量地）撒，洒,精细、少量、点缀式的分布
spray: （成雾状地）喷，喷洒,使用工具、成雾状或射流状的散布。
recrossing: 重新穿过
