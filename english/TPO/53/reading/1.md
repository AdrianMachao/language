...
come into light: 被发现、曝光、为人所知
assume to have been: 研究者（当时）推测他们（在此之前）早就是/一直是精英，准确地表达了“是精英”这个状态，发生在“研究者推测”这个动作之前
intellectual: 智力的，脑力的
intellect: 智力；理解力；才智
testify: 证明，证实;作证
modest：不大（或多、贵）的；适中的｜谦虚的，谦逊的
priest: 神父，牧师，司铎;（基督教以外的）神职人员
priestly: （像）神职人员的
caste:（印度社会的）种姓制度，种姓
invariably: 总，老是
priestly caste：祭司阶层
...
tally: 符合，吻合|计数；记录；比分
tallying: 计数、记录、核对数目
tabulators: 制表人；记账员；统计员
a virtual army of: 强调数量庞大、组织有序或力量强大的一组人或事物
laborsaving：省时省力的
scribal: 书吏的；抄写员的；书法的
hierarchy: 等级制度
drudgery: 辛苦乏味的工作
virtual: 实际上
stand to reason: 合乎逻辑；显而易见；按常理来说是清楚的
eased：减轻；减低；缓解
cease：停止，中止
